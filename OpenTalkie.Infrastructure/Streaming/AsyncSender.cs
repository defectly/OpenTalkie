...
public class AsyncSender : IDisposable
{
    ...
    private async Task SendAsync(ReadOnlyMemory<byte> samples, Endpoint endpoint)
    {
        ...
        Buffer.BlockCopy(runtime.NameBytes16, 0, sendBuffer, 8, 16);

        BitConverter.TryWriteBytes(sendBuffer.AsSpan(24, 4), runtime.FrameCount);
