...
{
    public const string defaultAndroidNotificationTitle = "Screen audio capturing in progress...";
    public const string defaultAndroidNotificationText = " A screen audio capturing is currently in progress";
